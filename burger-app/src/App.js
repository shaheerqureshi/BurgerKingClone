...
import GoogleApiWrapper from './Components/Resturants';
  ...
  return (
    <div className="App">
      ...
      <Switch>         
          ...
          <Route path="/Resturants" component={GoogleApiWrapper}/>
